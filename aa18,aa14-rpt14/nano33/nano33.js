...
// MongoDB connection
mongoose.connect("mongodb://localhost:27017/iot55", {
...
iotSchema.methods.info = function () {
    ...
    ? "Current date: " + this.date  + this.ax
...
parser.on('data', (data) => { // call back when data is received
    ...
    if (readData.lastIndexOf(',') > firstcommaidx && firstcommaidx > 0) {
        ...
        magy = readData.substring(eigthcommaidx + 1, readData.indexOf(',',eigthcommaidx+1));
        magz = readData.substring(readData.lastIndexOf(',')+1);
